...
import VenueBookingDetails from './VenueBookingDetails';
  ...
  return isLoading ? (
    ...
    <div className="all-doctor-list dashboard">
      {/* <div className="doctor-header">
        <Popup trigger={<button>Add New Venue</button>} 
                ...
                <tbody>
                  {searchResults.map((bumba) => (
                    <tr key={bumba._id}>
                      ...
                      <td>
                        <Popup trigger={<button>Other Details</button>} 
                          {...{  overlayStyle }}
                          position="bottom center" modal>
                            {(close) => (
                              <div className="scroll-component">
